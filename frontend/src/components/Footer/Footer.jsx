...
const Footer = () => {
  return (
    <BrowserRouter>
      ...
      >
        <div style={{ backgroundColor: "#51087E" }}>
          <MDBContainer>
        ...
        <MDBContainer className="mt-5 mb-4 text-center text-md-left">
          <MDBRow className="mt-3">
            <MDBCol md="3" lg="3    " xl="3" className="mb-4 dark-grey-text">
              ...
              />
              <p>
                The purpose of FarmX is to provide connections between different
                roles in the agriculture industry. As the farmers are not
                getting a fair price for their goods because of contractors.
            ...
            <MDBCol md="3" lg="3" xl="4" className="mb-4 dark-grey-text">
              ...
              />
              <p>
                <i className="fa fa-home mr-3" /> India
              </p>
              <p>
                <i className="fa fa-envelope mr-3" /> info@example.com
              </p>
              <p>
                <i className="fa fa-phone mr-3" /> + 91 234 567 88
              </p>
              <p>
                <i className="fa fa-print mr-3" /> + 91 234 567 89
              </p>
            </MDBCol>
